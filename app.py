...
GDPR_CONFIG = {
    ...
    # biometric processing retention
    "retention_days": 7,
...
def verify():
    ...
    try:
        ...
        selfie = decode_image_base64(
            data.get("selfie")
        )


        id_image = decode_image_base64(
            data.get("id_image")
        )
        ...
        live_score = basic_liveness_score(
            selfie
        )
        ...
        if (
            selfie_embedding is None
            or id_embedding is None
        ):
